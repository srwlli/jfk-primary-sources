...
const investigations: Investigation[] = [
  {
    ...
    icon: "gavel",
    summary:
      "The official investigation established by President Lyndon B. Johnson to investigate the assassination of President Kennedy, concluding that Lee Harvey Oswald acted alone.",
    background:
    ...
    mandate:
      "The commission was charged with evaluating all the facts and circumstances surrounding the assassination and the subsequent killing of the alleged assassin, and to report its findings and conclusions to the President. It had the power to subpoena witnesses, administer oaths, and obtain evidence from any executive department or agency.",
    keyFindings: [
  ...
  },
  {
    ...
    summary:
      "Congressional investigation that reinvestigated the assassinations of President Kennedy and Martin Luther King Jr., concluding that Kennedy was 'probably assassinated as a result of a conspiracy.'",
    background:
      "In the wake of Watergate and revelations about intelligence agency abuses, Congress established the House Select Committee on Assassinations in 1976 to reinvestigate the assassinations of President Kennedy and Dr. Martin Luther King Jr. The committee was created amid growing public skepticism about the Warren Commission's conclusions and new evidence that had emerged in the intervening years.",
    mandate:
...
export function getAllInvestigationIds(): string[] {
  return investigations.map((item) => item.id)
}
